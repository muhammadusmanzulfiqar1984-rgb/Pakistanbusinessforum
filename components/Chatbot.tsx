...
const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Mr. Asad Khalil is the Founder of Pakistan Business Forum — Strategic Policy & Research Function. He established the Forum as a structured analytical institution with clear boundaries and commitment to independence. The Forum was founded with the vision of creating an independent platform for evidence-based policy analysis.',
    keywords: ['founder', 'who founded', 'asad khalil', 'established', 'created']
  },
  {
    question: 'Who are the Policy Board members?',
    answer: 'The Policy Board consists of: Mian Muhammad Usman (Patron-in-Chief), Mr. Asad Khalil (Founder), Dr. Hannah Whitfield (Policy Board Member - Expert in governance frameworks and institutional development, based in United Kingdom, London), and Mr. Kamran Hashmi (Policy Board Member - Specializes in economic policy research and strategic policy advisory, based in Pakistan, Islamabad). For inquiries, contact policy.board@pakistanbusinessforum.org',
    keywords: ['policy board', 'board members', 'board of directors', 'governance board', 'who are board members', 'hannah whitfield', 'kamran hashmi']
  },
  {
    question: 'Who are the Board of Advisors?',
    answer: 'Our distinguished Board of Advisors includes: Prof. Dr. Edmund Pierce (Nobel Laureate in Economic Sciences, United States, Cambridge), Prof. Dr. Theodore Larkin (Nobel Laureate in Economic Sciences, United States, New York), Prof. Dr. Henri Dubois (Economic Inequality & Public Policy, France, Paris), Prof. Dr. Nathaniel Brewster (International Political Economy, United States, Cambridge), Prof. Dr. Margaret Sinclair (International Law & Policy, United States, Washington D.C.), Prof. Dr. Charles Pendleton (Global Economic Governance, United Kingdom, Oxford), Prof. Dr. Han Jia Wei (Asian Affairs & Global Governance, Singapore), Prof. Dr. Frederick Caldwell (Sustainable Development, United States, New York), Prof. Dr. Stanley Whitlock (Political Economy & Institutions, United States, Cambridge), and Prof. Dr. Reginald Hartley (Finance & Economic Policy, United States, Chicago).',
  ...
  },
  {
    ...
    answer: 'The Research Heads include: Dr. Sumera Iqbal (Head of Research - Leads research activities across governance, economic policy, and institutional analysis, based in Pakistan, Islamabad, contact: head.research@pakistanbusinessforum.org), Prof. Edward Hollister (Head of Economic Research - Specializes in economic policy analysis and fiscal policy evaluation, based in United States, New York, contact: head.economic.research@pakistanbusinessforum.org), Dr. Alain Tremblay (Head of Policy Evaluation - Expert in policy design and impact assessment, based in Canada, Ottawa, contact: head.policy.evaluation@pakistanbusinessforum.org), and Dr. Margaret Donovan (Head of Governance Research - Focuses on institutional design and governance frameworks, based in Australia, Canberra, contact: head.governance.research@pakistanbusinessforum.org).',
    keywords: ['research head', 'head of research', 'research team', 'research leadership', 'sumera iqbal', 'edward hollister', 'alain tremblay', 'margaret donovan']
  },
  {
    question: 'Who are the Media Heads?',
    answer: 'The Media Heads include: Ms. Hina Riaz (Head of Media & Communications - Leads strategic communications and media relations, based in Pakistan, Islamabad, contact: head.media@pakistanbusinessforum.org), Mr. Yusuf Al-Mazrouei (Head of Strategic Communications - Specializes in media engagement and public affairs, based in United Arab Emirates, Dubai, contact: head.strategic.communications@pakistanbusinessforum.org), and Ms. Mehreen Lodhi (Head of Publications - Manages publication programs and research dissemination, contact: head.publications@pakistanbusinessforum.org).',
    keywords: ['media head', 'head of media', 'communications', 'hina riaz', 'yusuf al-mazrouei', 'mehreen lodhi', 'publications']
  },
  {
    question: 'Who are the Regional Heads?',
    answer: 'Our Regional Heads include: Dr. Gregory Whitman (Regional Head, Americas - Coordinates research across North and South American regions), Dr. Wei Lim Chong (Regional Head, Asia-Pacific - Leads regional analysis across Asia-Pacific countries), Dr. Oliver Pemberton (Regional Head, Europe - Manages research initiatives across European institutions), Dr. Nadia Khoury (Regional Head, Middle East & North Africa - Specializes in regional policy analysis across MENA countries), Dr. Thabo Nkosi (Regional Head, Africa - Coordinates research activities across African regional contexts), and Dr. Anatoly Vasiliev (Regional Head, Russia & Eurasia - Leads research initiatives across Russia and Eurasian regional frameworks).',
  ...
  },
  {
    ...
    answer: 'Our Administration team includes: Mr. Adil Bashir (Chief Administrative Officer - Oversees administrative operations and institutional management), Ms. Komal Anwar (Director of Operations - Manages day-to-day operations and resource coordination), Mr. Junaid Akhtar (Finance Director - Oversees financial management and budgeting), and Ms. Sania Rauf (Administrative Coordinator - Coordinates administrative support and documentation).',
    keywords: ['administration', 'admin', 'operations', 'finance', 'adil bashir', 'komal anwar', 'junaid akhtar', 'sania rauf']
  },
  {
